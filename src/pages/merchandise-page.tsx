...
import { ShoppingBag, Package, Heart, Sparkles, BookOpen, Play } from 'lucide-react';
...
import fredericSullivanBookImage from 'figma:asset/4985639049dc05c3eee27db3ae240780957eecc0.png';
...
export function MerchandisePage() {
  ...
  const featuredItems = [
    ...
    {
      name: 'GSA Cap',
      description: 'Classic baseball cap with embroidered GSA logo',
      price: '$20',
    ...
    },
    {
      ...
      description: 'Carry your essentials in style with this witty Mikado reference',
      price: '$18',
      image: toteBagImage,
      badge: 'Fan Favorite',
      shopLink: 'https://www.printify.com', // Replace with actual Printify link
  ...
  return (
    <div className="min-h-screen bg-[#F8F3E6]">
            ...
            {additionalItems.map((item) => (
              <div key={item.name} className="group bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-[#F8F3E6] to-[#1E4D8B]/10">
                  {item.badge && (
                    <div className="absolute top-4 right-4 bg-[#8B5A8E] text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg z-10">
                      {item.badge}
                    </div>
                  )}
                  <img 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {digitalVideos.map((video) => (
              <div 
                key={video.title} 
                className={`group rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 ${
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-serif text-[#1E4D8B] mb-3">{video.title}</h3>
                  ...
                  <p className="text-[#1B365D]/80 mb-6 leading-relaxed min-h-[3rem]">{video.description}</p>
      ...
      {/* Books & Resources Section - MOVED TO BOTTOM */}
      <section className="py-20 bg-white/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <div className="bg-gradient-to-br from-[#F8F3E6] to-white rounded-3xl shadow-2xl overflow-hidden border-4 border-[#C9A961]">
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-8 md:p-10 flex flex-col justify-center">
                  ...
                  <a
                    href="https://www.amazon.com/Complete-Annotated-Gilbert-Sullivan-Anniversary/dp/0199392420/ref=sr_1_3?crid=22KPFVN8K3EW6&dib=eyJ2IjoiMSJ9.0mElVKWbWM7b9JnqJcT1pLhSd4BPoY_v3VMJS03TTWlX8yiKL-TSR-QCF8wPJ4qBcZhArxJ_Ps6nxhvQpNSR3z0mebFNOunDxYHAhviOJ1en4FvU7-rpo7hpYw6Kz7qZgg-1LS9DzLcvi4ksYUyOHxKmT9n25-BM2GfONA5xQbzzaws9sW200wSuTCVqe6PqHtMasjKw6Rw62f-rOoyBUG_Ph2w3MQVbzoXArGkvDK8.iQdHfjFcvIh3E7VErBAMq4cXy_xjLS6zuiamKh-y2fY&dib_tag=se&keywords=Gilbert+%26+sullivan&qid=1767942566&sprefix=gilbert+%26+sullivan+%2Caps%2C171&sr=8-3"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="bg-gradient-to-br from-[#F8F3E6] to-white rounded-3xl shadow-2xl overflow-hidden border-4 border-[#C9A961]">
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-8 md:p-10 flex flex-col justify-center">
                  ...
                  <p className="text-[#8B2F39] font-semibold mb-4 text-lg">By Elaine Richardson</p>
                  <p className="text-[#1B365D] leading-relaxed mb-6">
                    Discover the fascinating life of Frederic Sullivan, Arthur Sullivan's brother and the original Learned Judge in <em>Trial by Jury</em>. This meticulously researched biography by Elaine Richardson reveals the story of the man who created one of Gilbert & Sullivan's most iconic roles and his significant influence on the early Savoy operas.
                  </p>
